  ...
  <xsl:template match="/">
    <html lang="zh-CN" data-theme="dark">
      <head>
        ...
        <link rel="stylesheet" href="/css/style.css?v=h2bc58a831eba"/ integrity="sha384-pdO5wy3kHx7X42lKi7+kJaFlLpR65UPqm4Ci/xDeQU89HYn8G6e2XHLNRaxaz9a9" crossorigin="anonymous">
