...
@media(max-width:640px){.ah-hero{padding:30px 16px 26px}.ah-hero h1{font-size:1.6rem}.ah-era-strip,.ah-gallery{grid-template-columns:repeat(2,1fr);gap:10px}.ah-ceo-row{grid-template-columns:1fr}.ah-era{padding:12px 12px 13px}.ah-era-n{font-size:.92rem;margin:5px 0 6px}.ah-era-d{font-size:.76rem}.ah-fig-cap{padding:8px 10px 10px;font-size:.72rem}.ah-fig-cap b{font-size:.8rem}.ah-ev{grid-template-columns:1fr;gap:1px}.ah-ev-d{padding-top:0}.ah-pick{grid-template-columns:repeat(2,1fr)}.ah-lt{font-size:1.06rem}.ah-tl{padding:14px 12px 4px 30px}.ah-tl::before{left:13px}.ah-gh{padding:10px 12px}.ah-ceo-img{aspect-ratio:16/10}}
