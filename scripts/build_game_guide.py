...
# -*- coding: utf-8 -*-
"""
build_game_guide.py — 给玩过的游戏页面生成「值不值得玩」解读

背景：玩过的游戏 11 页是全站最薄的板块——只有战斗系统/探索要素/核心属性/装备系统
...
GAMES = [
    ...
    ("漫威蜘蛛侠 重制版", {
        "genre": "Insomniac Games 开发、索尼发行的开放世界动作冒险："
                 "2018 年 PS4 原作的高清重制版，PS5 版支持光线追踪与 DualSense 反馈。"
                 "剧情是原创的蜘蛛侠宇宙，时间线设在彼得披上战衣的第 8 年，"
                 "本作已打包「不夜城」三章 DLC",
        "who": "适合想在纽约楼群里体验摆荡爽感的玩家与漫威粉丝；"
               "反派线（尤其章鱼博士）写得扎实，想看一段完整故事的人不会失望。"
               "但它 2018 年的开放世界公式留下了痕迹，支线重复度偏高",
        "bar": "上手友好——四档难度随时可调且与奖杯解绑，摆荡还有辅助选项；"
               "战斗核心是「完美闪避攒专注、攒满处决」，"
               "把闪避时机练熟就能打得很顺，动作新手也能通关",
    }),
    ("漫威蜘蛛侠 2", {
        "genre": "Insomniac 的正统续作，2023 年 PS5 独占、2025 年才上 PC。"
                 "双主角彼得与迈尔斯可近即时切换，新增蛛丝翼滑翔、"
                 "毒液共生体战衣与格挡系统，地图从曼哈顿扩到皇后区与布鲁克林",
        "who": "适合玩过前两作、想看剧情收束的人——它直接接续前作结局，"
               "没玩过能看懂主线但好几处情感点会打折；"
               "追求战斗深度的也会满意，共生体战衣那一段是系列高光",
        "bar": "比一代多了格挡，需要判读敌人的连段节奏，"
               "但难度选项齐全、卡关随时降档；"
               "要注意主线约 17 小时偏短、支线密度也不如一代",
    }),
]
