...
def build_title_block(g):
    return (
        f'<title>{g["title_zh"]} | 玩过的游戏2026实测避坑｜龙兄知识库</title>\n'
        f'<meta name="keywords" content="{g["title_zh"]} | 玩过的游戏,2026实测避坑,实测溯源,龙兄知识库">\n\n'
        f'<meta name="description" content="{g["title_zh"]} | 玩过的游戏2026实测避坑：公开资料整理，发售信息、平台、类型与官方资讯。适合 {g["title_zh"]} 关注者与玩家参考。">\n'
    )


def build_og_twitter(g):
    return (
        f'<meta property="og:title" content="{g["title_zh"]} | 玩过的游戏2026实测避坑｜龙兄知识库">\n'
        f'<meta property="og:description" content="{g["title_zh"]} | 玩过的游戏2026实测避坑：公开资料整理，发售信息、平台、类型与官方资讯。">\n'
        ...
        f'<meta name="twitter:title" content="{g["title_zh"]} | 玩过的游戏">\n'
...
for g in GAMES:
    ...
    # 1b) 替换面包屑标题
    out = out.replace(
        '<a href="../games.html">玩过的游戏</a><span>›</span>\n<span>侠盗猎车手 VI</span>',
        f'<a href="../games.html">玩过的游戏</a><span>›</span>\n<span>{g["title_zh"]}</span>',
    )
    ...
    # 6) 替换 title + meta
    out = out.replace(
        '<title>侠盗猎车手 VI | 玩过的游戏2026实测避坑｜龙兄知识库</title>\n'
        '<meta name="keywords" content="侠盗猎车手 VI | 玩过的游戏,2026实测避坑,实测溯源,龙兄知识库">\n\n'
        '<meta name="description" content="侠盗猎车手 VI | 玩过的游戏2026实测避坑：实测溯源、实操图文、避坑指南。适合侠盗猎车手 VI | 玩过的游戏爱好者与从业者参考，掌握核心要点、规避常见误区。">\n',
        build_title_block(g),
    )
    # 7) 替换 og / twitter
    out = out.replace(
        '<meta property="og:title" content="侠盗猎车手 VI | 玩过的游戏2026实测避坑｜龙兄知识库">\n'
        '<meta property="og:description" content="侠盗猎车手 VI | 玩过的游戏2026实测避坑：实测溯源、实操图文、避坑指南。适合侠盗猎车手 VI | 玩过的游戏爱好者与从业者参考，掌握核心要点、规避常见误区。">\n'
        ...
        '<meta name="twitter:title" content="侠盗猎车手 VI | 玩过的游戏">\n'
