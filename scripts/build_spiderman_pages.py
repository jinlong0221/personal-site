...
T_TITLE_OLD = "黑神话：悟空 | 玩过的游戏2026实测避坑｜龙兄知识库"
T_KW_OLD = "黑神话：悟空 | 玩过的游戏,2026实测避坑,实测溯源,龙兄知识库"
T_DESC_OLD = (
    "黑神话：悟空 | 玩过的游戏2026实测避坑：实测溯源、实操图文、避坑指南。"
    "适合黑神话：悟空 | 玩过的游戏爱好者与从业者参考，掌握核心要点、规避常见误区。"
)
T_TW_TITLE_OLD = "黑神话：悟空 | 玩过的游戏"
T_TW_DESC_OLD = (
...
def build(cfg):
    ...
    title_new = f"{zh} | 玩过的游戏2026实测避坑｜龙兄知识库"
    kw_new = f"{zh} | 玩过的游戏,2026实测避坑,实测溯源,龙兄知识库"
    desc_new = (
        f"{zh} | 玩过的游戏2026实测避坑：实测溯源、实操图文、避坑指南。"
        f"适合{zh} | 玩过的游戏爱好者与从业者参考，掌握核心要点、规避常见误区。"
    )
    url_new = f"https://longxiong.vip/games/{slug}.html"
    tw_title_new = f"{zh} | 玩过的游戏"
